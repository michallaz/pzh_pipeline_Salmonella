...
COPY bin/json_output_contaminations.py bin/coverage_filter.py bin/calculate_stats.py bin/run_VFDB.sh bin/run_fastqc_and_generate_json.py bin/initial_mlst_parser.py bin/extract_final_stats_parser.py bin/resfinder_parser.py /opt/docker/EToKi/externals
