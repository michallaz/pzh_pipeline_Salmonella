...
COPY bin/json_output_contaminations.py bin/coverage_filter.py bin/calculate_stats.py bin/run_VFDB.sh bin/run_fastqc_and_generate_json.py /opt/docker/EToKi/externals
